...
public interface GoodsClassMapper extends BaseMapper<GoodsClass> {
    ...
    int selectGoodsClassCount(@Param(Constants.WRAPPER) Wrapper<GoodsClass> wrapper);
    ...
    IPage<GoodsClassificationResponse> selectGoodsClassList(IPage<GoodsClass> page, @Param(Constants.WRAPPER) Wrapper<GoodsClass> wrapper);

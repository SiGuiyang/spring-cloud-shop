...
CREATE TABLE `t_user_order` (
  ...
  `delivery_address_id` bigint(20) DEFAULT NULL COMMENT 't_address 主键',
...
-- ----------------------------
BEGIN;
INSERT INTO `t_user_order` VALUES ('1', '1', '13818471341', '1', '1', 'wsdfr3322edf', 'BS001', '1', '1.00', '111', '11.00', '20', '1', null, null, '2019-01-13 15:59:00', '2019-01-13 15:59:30', b'0');
COMMIT;
